...
- **[Clicks Protocol](https://github.com/clicks-protocol/clicks-protocol)** - Autonomous DeFi yield for AI agents on Base. 9 MCP tools for treasury management: query APY rates, simulate payment splits, register agents, deposit/withdraw USDC. 80/20 split, Aave V3 + Morpho routing.
